...
for.end42:                                        ; preds = %for.cond13
  ...
  %arrayidx44 = getelementptr inbounds [512 x [512 x i32]], [512 x [512 x i32]]* %c, i64 0, i64 %idxprom43
  %26 = load i32, i32* %j, align 4
  %idxprom45 = sext i32 %26 to i64
  %arrayidx46 = getelementptr inbounds [512 x i32], [512 x i32]* %arrayidx44, i64 0, i64 %idxprom45
  %27 = load i32, i32* %arrayidx46, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32 %27)
  ret i32 0
}
