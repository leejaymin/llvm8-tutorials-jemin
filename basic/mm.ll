...
for.body18:                                       ; preds = %for.cond16
  ...
  %arrayidx20 = getelementptr inbounds [512 x [512 x i32]], [512 x [512 x i32]]* %a, i64 0, i64 %idxprom19
  %13 = load i32, i32* %k, align 4
  %idxprom21 = sext i32 %13 to i64
  %arrayidx22 = getelementptr inbounds [512 x i32], [512 x i32]* %arrayidx20, i64 0, i64 %idxprom21
  ...
  store i32 %14, i32* %abc, align 4
  store i32 0, i32* %j, align 4
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc34, %for.body18
  %15 = load i32, i32* %j, align 4
  %cmp24 = icmp slt i32 %15, 512
  br i1 %cmp24, label %for.body25, label %for.end36

for.body25:                                       ; preds = %for.cond23
  %16 = load i32, i32* %abc, align 4
